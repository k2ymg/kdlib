...
Converted from 'd3d9types.h'.

Version: DirectX 11 SDK February 2010, Windows SDK v7.0
Authors: Koji Kishita
*/
module c.windows.d3d9types;
...
enum DIRECT3D_VERSION = 0x0900;

//(DIRECT3D_VERSION >= 0x0900)
alias DWORD D3DCOLOR;

pure nothrow
D3DCOLOR D3DCOLOR_ARGB(DWORD a, DWORD r, DWORD g, DWORD b)
{
	return cast(D3DCOLOR)(((a & 0xff) << 24) | ((r & 0xff)<<16) | ((g & 0xff) << 8) | (b &0xff));
}

pure nothrow
D3DCOLOR D3DCOLOR_RGBA(DWORD r, DWORD g, DWORD b, DWORD a)
{
	return D3DCOLOR_ARGB(a, r, g, b);
}

pure nothrow
D3DCOLOR D3DCOLOR_XRGB(DWORD r, DWORD g, DWORD b)
{
	return D3DCOLOR_ARGB(0xff, r, g, b);
}

pure nothrow
D3DCOLOR D3DCOLOR_XYUV(DWORD y, DWORD u, DWORD v)
{
	return D3DCOLOR_ARGB(0xff, y, u, v);
}

pure nothrow
D3DCOLOR D3DCOLOR_AYUV(DWORD a, DWORD y, DWORD u, DWORD v)
{
...
{
	return D3DCOLOR_RGBA(cast(DWORD)(r * 255.f), cast(DWORD)(g * 255.f), cast(DWORD)(b * 255.f), cast(DWORD)(a * 255.f));
}
...
alias int D3DTRANSFORMSTATETYPE;
...
alias int D3DRENDERSTATETYPE;

enum D3D_MAX_SIMULTANEOUS_RENDERTARGETS = 4;
...
alias int D3DMATERIALCOLORSOURCE;

enum D3DRENDERSTATE_WRAPBIAS = 128UL;
...
alias int D3DTEXTURESTAGESTATETYPE;
...
alias int D3DSAMPLERSTATETYPE;

enum D3DDMAPSAMPLER = 256;
...
alias int D3DTEXTUREFILTERTYPE;

enum D3DPV_DONOTCOPYDATA = 1 << 0;
...
alias int D3DDECLMETHOD;

enum MAXD3DDECLMETHOD = D3DDECLMETHOD_LOOKUPPRESAMPLED;
...
alias int D3DDECLTYPE;

enum MAXD3DDECLTYPE = D3DDECLTYPE_UNUSED;
...
const D3DVERTEXELEMENT9 D3DDECL_END = {0xFF, 0, D3DDECLTYPE_UNUSED, 0, 0, 0};
...
alias int D3DSHADER_INSTRUCTION_OPCODE_TYPE;

//D3DSINCOSCONST1 -1.5500992e-006f, -2.1701389e-005f, 0.0026041667f, 0.00026041668f
//D3DSINCOSCONST2 -0.020833334f, -0.12500000f, 1.0f, 0.50000000f

enum D3DSI_COISSUE = 0x40000000;

enum D3DSP_OPCODESPECIFICCONTROL_MASK = 0x00ff0000;
enum D3DSP_OPCODESPECIFICCONTROL_SHIFT = 16;

enum D3DSI_TEXLD_PROJECT = (0x01 << D3DSP_OPCODESPECIFICCONTROL_SHIFT);
enum D3DSI_TEXLD_BIAS = (0x02 << D3DSP_OPCODESPECIFICCONTROL_SHIFT);
...
alias int D3DSHADER_COMPARISON;

enum {
	D3DSHADER_COMPARISON_SHIFT       = D3DSP_OPCODESPECIFICCONTROL_SHIFT,
	D3DSHADER_COMPARISON_MASK        = 0x7 << D3DSHADER_COMPARISON_SHIFT,
	D3DSHADER_INSTRUCTION_PREDICATED = 0x1 << 28,
}
...
alias int D3DSAMPLER_TEXTURE_TYPE;

enum {
	D3DSP_REGNUM_MASK   = 0x000007FF,
...
alias int D3DSHADER_PARAM_REGISTER_TYPE;

enum {
	D3DSMO_POSITION  = 0,
	D3DSMO_FACE      = 1,
}
alias int D3DSHADER_MISCTYPE_OFFSETS;
...
alias int D3DVS_RASTOUT_OFFSETS;
...
alias int D3DVS_ADDRESSMODE_TYPE;

enum {
	D3DSHADER_ADDRESSMODE_SHIFT = 13,
	D3DSHADER_ADDRESSMODE_MASK  = 1 << D3DSHADER_ADDRESSMODE_SHIFT,
}
...
alias int D3DSHADER_ADDRESSMODE_TYPE;
...
alias int D3DSHADER_PARAM_SRCMOD_TYPE;

pure nothrow
DWORD D3DPS_VERSION(DWORD _Major, DWORD _Minor)
{
	return 0xFFFF0000 |(_Major << 8) | _Minor;
}

pure nothrow
DWORD D3DVS_VERSION(DWORD _Major, DWORD _Minor)
{
	return 0xFFFE0000 | (_Major << 8) | _Minor;
}

pure nothrow
DWORD D3DSHADER_VERSION_MAJOR(DWORD _Version)
{
	return (_Version >> 8) & 0xFF;
}

pure nothrow
DWORD D3DSHADER_VERSION_MINOR(DWORD _Version)
{
...
DWORD D3DSHADER_COMMENT(DWORD _DWordSize)
{
	return ((_DWordSize << D3DSI_COMMENTSIZE_SHIFT) & D3DSI_COMMENTSIZE_MASK) | D3DSIO_COMMENT;
}

enum {
	D3DPS_END = 0x0000FFFF,
	D3DVS_END = 0x0000FFFF,
}
...
alias int D3DTEXTURETRANSFORMFLAGS;
...
alias int D3DDEBUGMONITORTOKENS;
...
enum D3DRTYPECOUNT = (D3DRTYPE_INDEXBUFFER+1);
...
enum {
	D3DCOMPOSERECTS_MAXNUMRECTS  = 0xFFFF,
...
alias int D3DAUTHENTICATEDCHANNELTYPE;
...
mixin DEFINE_GUID!("D3DAUTHENTICATEDQUERY_PROTECTION", 0xa84eb584, 0xc495, 0x48aa, 0xb9, 0x4d, 0x8b, 0xd2, 0xd6, 0xfb, 0xce, 0x5);
...
mixin DEFINE_GUID!("D3DAUTHENTICATEDQUERY_CHANNELTYPE", 0xbc1b18a5, 0xb1fb, 0x42ab, 0xbd, 0x94, 0xb5, 0x82, 0x8b, 0x4b, 0xf7, 0xbe);
...
mixin DEFINE_GUID!("D3DAUTHENTICATEDQUERY_DEVICEHANDLE", 0xec1c539d, 0x8cff, 0x4e2a, 0xbc, 0xc4, 0xf5, 0x69, 0x2f, 0x99, 0xf4, 0x80);
...
mixin DEFINE_GUID!("D3DAUTHENTICATEDQUERY_CRYPTOSESSION", 0x2634499e, 0xd018, 0x4d74, 0xac, 0x17, 0x7f, 0x72, 0x40, 0x59, 0x52, 0x8d);
...
mixin DEFINE_GUID!("D3DAUTHENTICATEDQUERY